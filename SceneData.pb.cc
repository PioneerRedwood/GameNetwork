...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_SceneData_2eproto[3];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_SceneData_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_SceneData_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_SceneData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_SceneData_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017SceneData.proto\022\010tutorial\"\333\001\n\006Person\022\014"
  ...
  "2\020.tutorial.Person"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_SceneData_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_SceneData_2eproto = {
  false, false, 298, descriptor_table_protodef_SceneData_2eproto, "SceneData.proto", 
  &descriptor_table_SceneData_2eproto_once, nullptr, 0, 3,
  schemas, file_default_instances, TableStruct_SceneData_2eproto::offsets,
  file_level_metadata_SceneData_2eproto, file_level_enum_descriptors_SceneData_2eproto, file_level_service_descriptors_SceneData_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_SceneData_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_SceneData_2eproto);
  return descriptor_table_SceneData_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_SceneData_2eproto(&descriptor_table_SceneData_2eproto);
namespace tutorial {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Person_PhoneType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_SceneData_2eproto);
  return file_level_enum_descriptors_SceneData_2eproto[0];
}
